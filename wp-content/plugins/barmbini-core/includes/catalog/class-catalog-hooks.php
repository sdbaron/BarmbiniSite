	...
	protected function get_inline_styles() {
		return implode(
			...
			array(
				...
				'.woocommerce-product-gallery__image img:not(.zoomImg) { width: max(25vw, 170px) !important; height: max(25vw, 170px) !important; object-fit: cover; object-position: center; }',
