...
define( 'BARMBINI_CORE_VERSION', '0.10.5' );
...
require_once BARMBINI_CORE_PATH . 'includes/catalog/class-progressive-bg.php';
...
require_once BARMBINI_CORE_PATH . 'includes/frontend/class-frontend-assets.php';
...
require_once BARMBINI_CORE_PATH . 'includes/roles/class-roles.php';
